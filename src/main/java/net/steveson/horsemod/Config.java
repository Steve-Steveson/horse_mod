...
public class Config {
    ...
    // 15 - 30
    public static final ModConfigSpec.DoubleValue H_MAX_HEALTH = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue H_MIN_HEALTH = BUILDER
    ...
    // 0.4 - 1
    public static final ModConfigSpec.DoubleValue H_MAX_JUMP = BUILDER
            .comment("")
    ...
    public static final ModConfigSpec.DoubleValue H_MIN_JUMP = BUILDER
    ...
    // 0.1125 - 0.3375
    public static final ModConfigSpec.DoubleValue H_MAX_SPEED = BUILDER
            .comment("")
    ...
    public static final ModConfigSpec.BooleanValue FAST_FOOD = BUILDER
            .comment("Whether horses can snack while being ridden")
            .define("fastFood", false);

    public static final ModConfigSpec.BooleanValue KEEP_MATCHING_STATS = BUILDER
